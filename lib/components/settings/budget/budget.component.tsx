...
export const Budget: React.FC = () => {
  ...
  return (
    <View className="flex-1 bg-bg">
      <ScrollView
        className="flex-1"
        contentContainerStyle={{ paddingTop: insets.top, paddingBottom: 24, paddingHorizontal: 24 }}
      ...
      <KeyboardStickyView>
        <View
          className="bg-bg px-6 pt-4"
          style={{ paddingBottom: insets.bottom + 12 }}
        >
          <Pressable onPress={save} className="items-center rounded-2xl bg-accent py-[17px] active:opacity-80">
          ...
          {budget !== null && (
            <Pressable onPress={remove} className="mt-1.5 items-center py-2.5 active:opacity-60">
